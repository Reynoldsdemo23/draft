...
\pnum
\effects
Move constructs from \tcode{other} (\tref{moveconstructible}).
...
\rSec3[fs.filesystem_error.members]{Members}
...
\rSec3[fs.file_status.cons]{Constructors}
...
\rSec3[fs.file_status.obs]{Observers}
...
\rSec3[fs.file_status.mods]{Modifiers}
